...
docker build -t "us-central1-docker.pkg.dev/project-cdd074dc-6291-4d7f-a2a/tradeforces/tradeforces-main:1.1" -f microservices/main/Dockerfile .
...
docker build -t "us-central1-docker.pkg.dev/project-cdd074dc-6291-4d7f-a2a/tradeforces/tradeforces-vmcreator:1.1" -f microservices/vm_creator/Dockerfile .
...
docker build -t "us-central1-docker.pkg.dev/project-cdd074dc-6291-4d7f-a2a/tradeforces/tradeforces-telemetry:1.1" -f microservices/telemetry/Dockerfile microservices/telemetry
